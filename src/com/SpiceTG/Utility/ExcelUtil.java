...
public class ExcelUtil extends SpiceTG_GlobalVariables {
	/*
    ...
    public static void setExcelFileSheet(String sheetName) throws Exception {
        ...
        if (Platform.getCurrent().toString().equalsIgnoreCase("MAC")) {
            testDataExcelPath = currentDir + "D:/Automation/Automation_Project/SpiceTG-Automation/Excel Files/testdata.xlsx";
